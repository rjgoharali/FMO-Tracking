CREATE TABLE IF NOT EXISTS users (id TEXT PRIMARY KEY, employee_code TEXT UNIQUE NOT NULL, name TEXT NOT NULL, role TEXT NOT NULL, password_hash TEXT NOT NULL, is_active INTEGER NOT NULL DEFAULT 1, phone TEXT, email TEXT, created_at TEXT NOT NULL);
...
CREATE TABLE IF NOT EXISTS attendance (id TEXT PRIMARY KEY, duty_session_id TEXT UNIQUE NOT NULL, fmo_id TEXT NOT NULL, check_in_time TEXT NOT NULL, selfie_path TEXT, latitude REAL NOT NULL, longitude REAL NOT NULL, accuracy REAL NOT NULL, superseded_at TEXT, reset_reason TEXT);
